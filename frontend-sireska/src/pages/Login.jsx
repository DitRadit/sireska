...
const Login = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row min-h-screen bg-white font-sans">
            ...
            <div
                className="flex-1 md:w-1/2 bg-white flex flex-col items-center justify-center p-8 -mt-8 md:mt-0 rounded-t-[32px] md:rounded-none relative z-20">
                ...
                <div className="w-full max-w-sm flex flex-col mt-2 md:mt-0">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="flex justify-end mt-1">
                                <Link
                                    to="/forgot-password"
                                    className="text-[11px] text-[#ff6b2c] hover:underline font-semibold">
                                    Forgot password?
                                </Link>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center gap-3 mt-8">
                        ...
                        <button
                            className="flex items-center justify-center w-12 h-12 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors shadow-sm">
